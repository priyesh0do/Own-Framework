...
public class Customer_Information_Customer_Detail_Screen_COM  extends BaseClass{
...
Login login;
	...
	public void VerifyCustomer_Information_Customer_Detail_Screen_COM() throws InterruptedException, IOException, ParseException {
		
		test = Report.testCreate(extent, test, "Customer_Information_Customer_Detail_Screen_COM ");
		...
		Thread.sleep(1000);
	    cd.Opus_Confirmation_VerifyCustomer_Information_Customer_Detail_Screen_COM("All","20");
	    Thread.sleep(1000);
