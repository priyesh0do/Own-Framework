...
public class PrintCustomerTicketoption_COM extends BaseClass{
...
Login login;
	...
	public void VerifyPrintCustomerTicketoption_COM() throws InterruptedException, IOException, ParseException {
		...
		sitedetail.verifyCustomerTicket();
		Thread.sleep(1000);
}
}