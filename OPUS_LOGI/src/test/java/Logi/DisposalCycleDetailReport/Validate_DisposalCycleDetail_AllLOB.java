...
public class Validate_DisposalCycleDetail_AllLOB extends BaseClass{
	...
	public void Validation_DisposalCycleDetailReport_AllLOB(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_DisposalCycleDetailReport_AllLOB") & RunMode.equals("Yes"))
		{

		    test = Report.testCreate(extent, test, "Validate_DisposalCycleDetailReport_AllLOB");
