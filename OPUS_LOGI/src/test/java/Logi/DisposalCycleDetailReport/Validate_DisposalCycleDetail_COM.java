...
public class Validate_DisposalCycleDetail_COM extends BaseClass{
	...
	public void Validation_DisposalCycleDetailReport_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_DisposalCycleDetailReport_COM") & RunMode.equals("Yes"))
		{

		    test = Report.testCreate(extent, test, "Validate_DisposalCycleDetailReport_COM");
