...
public class Validate_DisposalCycleDetail_RO extends BaseClass{
	...
	public void Validation_DisposalCycleDetailReport_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_DisposalCycleDetailReport_RO") & RunMode.equals("Yes"))
		{

		    test = Report.testCreate(extent, test, "Validate_DisposalCycleDetailReport_RO");
