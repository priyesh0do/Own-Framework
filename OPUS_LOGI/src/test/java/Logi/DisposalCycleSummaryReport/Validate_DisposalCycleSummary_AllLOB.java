...
public class Validate_DisposalCycleSummary_AllLOB extends BaseClass{
	...
	public void Validation_DisposalCycleSummaryReport_DataValidation_AllLOB(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_DisposalCycleSummaryReport_AllLOB") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_DisposalCycleSummaryReport_AllLOB");
