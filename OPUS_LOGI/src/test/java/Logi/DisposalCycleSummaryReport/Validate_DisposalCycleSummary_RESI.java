...
public class Validate_DisposalCycleSummary_RESI extends BaseClass{
	...
	public void Validation_DisposalCycleSummaryReport_DataValidation_RESI(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_DisposalCycleSummaryReport_RESI") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_DisposalCycleSummaryReport_RESI");
