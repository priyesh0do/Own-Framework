...
public class Validate_DisposalCycleSummary_RO extends BaseClass{
	...
	public void Validation_DisposalCycleSummaryReport_DataValidation_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_DisposalCycleSummaryReport_RO") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_DisposalCycleSummaryReport_RO");
