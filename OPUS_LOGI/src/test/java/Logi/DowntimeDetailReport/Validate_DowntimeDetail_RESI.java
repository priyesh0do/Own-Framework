...
public class Validate_DowntimeDetail_RESI extends BaseClass{
	Login login;
	HomePage sdiMegaObj;
	FilterSection sdoFilterObj;
	DowntimeDetailReport DowntimeDetailObj;
	@Test(groups = "Opus", dataProvider = "LOGI_Reports_Data")
	public void Validation_DowntimeDetailReport_RESI(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_DowntimeDetailReport_RESI") & RunMode.equals("Yes"))
		{
			 test = Report.testCreate(extent, test, "Validate_DowntimeDetailReport_RESI");
