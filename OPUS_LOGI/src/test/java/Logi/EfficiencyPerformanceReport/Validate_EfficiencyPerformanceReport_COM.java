...
public class Validate_EfficiencyPerformanceReport_COM extends BaseClass{
	Login login;
	HomePage sdiMegaObj;
	...
	public void Validation_EfficiencyPerformanceReport_DetailSection_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_EfficiencyPerformanceReport_COM") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_EfficiencyPerformanceReport_COM");
