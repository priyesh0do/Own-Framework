...
public class Validate_EfficiencyPerformanceReport_RO extends BaseClass{
	...
	public void Validation_EfficiencyPerformanceReport_DetailSection_RESI(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_EfficiencyPerformanceReport_RO") & RunMode.equals("Yes"))
		{
			...
			Thread.sleep(1000);
			effPerformanceObj.validateSummaryData_RO(actualSummaryTable, actualPerformanceTable, LOB, Route, Driver, FromDate, ToDate);
