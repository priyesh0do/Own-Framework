...
public class Validate_EfficiencySummaryReport_COM extends BaseClass{
	...
	public void Validation_EfficiencySummaryReport_DataValidation_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_EfficiencySummaryReport_COM") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_EfficiencySummaryReport_COM");
