...
public class Validate_EfficiencySummaryReport_RESI extends BaseClass{
	...
	public void Validation_EfficiencySummaryReport_DataValidation_RESI(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_EfficiencySummaryReport_RESI") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_EfficiencySummaryReport_RESI");
