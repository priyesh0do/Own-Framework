...
public class Validate_IdleDetail_AllLOB extends BaseClass{
	...
	public void Validation_IdleDetailReport_AllLOB(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_IdleDetailReport_AllLOB") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_IdleDetailReport_AllLOB");
