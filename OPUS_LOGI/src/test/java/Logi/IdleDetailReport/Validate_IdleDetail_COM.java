...
public class Validate_IdleDetail_COM extends BaseClass{
	...
	public void Validation_IdleDetailReport_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_IdleDetailReport_COM") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_IdleDetailReport_COM");
