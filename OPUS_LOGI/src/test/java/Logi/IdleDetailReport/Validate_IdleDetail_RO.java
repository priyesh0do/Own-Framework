...
public class Validate_IdleDetail_RO extends BaseClass{
	...
	public void Validation_IdleDetailReport_Resi(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_IdleDetailReport_RO") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_IdleDetailReport_RO");
