...
public class Validate_IdleSummary_COM extends BaseClass{
	...
	public void Validation_IdleSummaryReport_DataValidation_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_IdleSummaryReport_COM") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_IdleSummaryReport_COM");
