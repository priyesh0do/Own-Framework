...
public class Validate_IdleSummary_RESI extends BaseClass{
	...
	public void Validation_EfficiencySummaryReport_DataValidation_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_IdleSummaryReport_RESI") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_IdleSummaryReport_RESI");
