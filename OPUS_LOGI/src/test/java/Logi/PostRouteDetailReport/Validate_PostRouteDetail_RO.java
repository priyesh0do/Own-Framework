...
public class Validate_PostRouteDetail_RO extends BaseClass{
	Login login;
	HomePage sdiMegaObj;
	FilterSection sdoFilterObj;
	PostRouteDetailReport PostroutedetailObj;
	@Test(groups = "Opus", dataProvider = "LOGI_Reports_Data")
	public void Validation_PostRouteDetailReport_DataValidation_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_PostRouteDetailReport_RO") & RunMode.equals("Yes"))
		{
