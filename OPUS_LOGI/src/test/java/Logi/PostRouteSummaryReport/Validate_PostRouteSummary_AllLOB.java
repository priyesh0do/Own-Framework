...
public class Validate_PostRouteSummary_AllLOB extends BaseClass{
	Login login;
	HomePage sdiMegaObj;
	FilterSection sdoFilterObj;
	PostRouteSummary PostrouteSummaryObj;
	@Test(groups = "Opus", dataProvider = "LOGI_Reports_Data")
	public void Validation_PostRouteSummaryReport_DataValidation_AllLOB(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_PostRouteSummaryReport_AllLOB") & RunMode.equals("Yes"))
		{
			test = Report.testCreate(extent, test, "Validate_PostRouteDetailReport_AllLOB");
