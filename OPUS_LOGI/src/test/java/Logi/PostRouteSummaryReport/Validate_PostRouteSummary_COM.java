...
public class Validate_PostRouteSummary_COM extends BaseClass{
	...
	public void Validation_PostRouteSummaryReport_DataValidation_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_PostRouteSummaryReport_COM") & RunMode.equals("Yes"))
		{
