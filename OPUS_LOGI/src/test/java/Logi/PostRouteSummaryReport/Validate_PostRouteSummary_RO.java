...
public class Validate_PostRouteSummary_RO extends BaseClass{
	Login login;
	HomePage sdiMegaObj;
	FilterSection sdoFilterObj;
	PostRouteSummary PostrouteSummaryObj;
	@Test(groups = "Opus", dataProvider = "LOGI_Reports_Data")
	public void Validation_PostRouteSummaryReport_DataValidation_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_PostRouteSummaryReport_RO") & RunMode.equals("Yes"))
		{
			test = Report.testCreate(extent, test, "Validate_PostRouteDetailReport_RO");
