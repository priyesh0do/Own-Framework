...
public class Validate_PreRouteDetail_AllLOB extends BaseClass{
	Login login;
	HomePage sdiMegaObj;
	...
	public void Validation_PreRouteDetailReport_DataValidation_AllLOB(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_PreRouteDetailReport_AllLOB") & RunMode.equals("Yes"))
		{
			test = Report.testCreate(extent, test, "Validate_PreRouteDetailReport_AllLOB");
