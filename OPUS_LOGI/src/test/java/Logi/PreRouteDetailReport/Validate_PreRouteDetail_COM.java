...
public class Validate_PreRouteDetail_COM extends BaseClass {
	Login login;
	HomePage sdiMegaObj;
	...
	public void Validation_PreRouteDetailReport_DataValidation_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_PreRouteDetailReport_COM") & RunMode.equals("Yes"))
		{
			
			test = Report.testCreate(extent, test, "Validate_PreRouteDetailReport_COM");
