...
public class Validate_PreRouteSummary_RESI extends BaseClass{
	...
	public void Validation_PreRouteDetailReport_DataValidation_RESI(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_PreRouteSummaryReport_RESI") & RunMode.equals("Yes"))
		{
			test = Report.testCreate(extent, test, "Validate_PreRouteSummaryReport_RESI");
