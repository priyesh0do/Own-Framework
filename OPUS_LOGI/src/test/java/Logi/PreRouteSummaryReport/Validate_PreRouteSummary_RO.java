...
public class Validate_PreRouteSummary_RO extends BaseClass {
	Login login;
	HomePage sdiMegaObj;
	...
	public void Validation_PreRouteDetailReport_DataValidation_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_PreRouteSummaryReport_RO") & RunMode.equals("Yes"))
		{
			test = Report.testCreate(extent, test, "Validate_PreRouteSummaryReport_RO");
