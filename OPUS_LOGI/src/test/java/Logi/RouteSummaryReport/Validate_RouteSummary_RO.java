...
public class Validate_RouteSummary_RO extends BaseClass 
{
	Login login;
	HomePage sdiMegaObj;
	...
	public void Validation_RouteSummaryReport_DataValidation_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
	...
	if(Scenario.equalsIgnoreCase("Validate_RouteSummaryReport_RO") & RunMode.equals("Yes"))
	{
		test = Report.testCreate(extent, test, "Validate_RouteSummaryReport_RO");
		...
		Util.switchToDefaultWindow();
		Util.selectFrame("opusReportContainer,subReportContainer");	
		Map<String,List<String>> efficiencySummaryROTableData=effSumObj.getActualSummaryTableData();
		driver.close();
		...
		Util.selectFrame("opusReportContainer,subReportContainer");
		Thread.sleep(3000);
		Map<String,List<String>> efficiencyPerformanceROPerformanceTableData=effPerfObj.getActualPerformanceSubViewTableData();
		//driver.close();
		//Util.switchToDefaultTab();
		...
		Map<String,List<String>> efficiencyPerformanceRORouteSegmentTableData=effPerfObj.getActualRouteSegmentsSubViewTableData();
		driver.close();
		Util.switchToDefaultTab();
		//**********************************************************************************************************************************************************
		//Switching to Efficiency Performance Table
		...
		Util.selectFrame("opusReportContainer,subReportContainer");
		Thread.sleep(3000);
		Map<String,List<String>> sequenceComplianceROTableData=seqComObj.getActualSummaryTableData();
		driver.close();
		Util.switchToDefaultTab();
		
		RouteSummaryObj.validateRouteSummaryDetailSection(SiteID,actualDetailTable,efficiencySummaryROTableData,efficiencyPerformanceROPerformanceTableData,efficiencyPerformanceRORouteSegmentTableData,sequenceComplianceROTableData);
