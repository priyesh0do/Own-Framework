...
public class Validate_SalesInformationDetail_COM extends BaseClass{
	...
	public void Validation_SalesInformationDetailReport_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_SalesInformationDetail_COM") & RunMode.equals("Yes"))
		{
			    test = Report.testCreate(extent, test, "Validate_SalesInformationDetail_COM");
