...
public class Validate_SalesInformationDetail_RESI extends BaseClass{
	Login login;
	HomePage sdiMegaObj;
	...
	public void Validation_SalesInformationDetailReport_RESI(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_SalesInformationDetail_RESI") & RunMode.equals("Yes"))
		{
			    test = Report.testCreate(extent, test, "Validate_SalesInformationDetail_RESI");
