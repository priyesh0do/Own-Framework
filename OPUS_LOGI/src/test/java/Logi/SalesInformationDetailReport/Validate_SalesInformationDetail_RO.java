...
public class Validate_SalesInformationDetail_RO extends BaseClass{
	Login login;
	HomePage sdiMegaObj;
	...
	public void Validation_SalesInformationDetailReport_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_SalesInformationDetail_RO") & RunMode.equals("Yes"))
		{
			    test = Report.testCreate(extent, test, "Validate_SalesInformationDetail_RO");
