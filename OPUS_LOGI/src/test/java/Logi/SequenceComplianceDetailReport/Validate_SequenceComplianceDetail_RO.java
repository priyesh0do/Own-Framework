...
public class Validate_SequenceComplianceDetail_RO extends BaseClass{
	...
	public void Validation_SequenceComplianceDetailReport_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_SequenceComplianceDetailReport_RO") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_SequenceComplianceDetailReport_RO");
