...
public class Validate_SequenceComplianceSummary_COM extends BaseClass{
	...
	public void Validation_SequenceComplianceSummaryReport_DataValidation_COM(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_SequenceComplianceSummaryReport_COM") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_SequenceComplianceSummaryReport_COM");
