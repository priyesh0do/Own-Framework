...
public class Validate_SequenceComplianceSummary_RO extends BaseClass{
	...
	public void Validation_SequenceComplianceSummaryReport_DataValidation_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_SequenceComplianceSummaryReport_RO") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_SequenceComplianceSummaryReport_RO");
