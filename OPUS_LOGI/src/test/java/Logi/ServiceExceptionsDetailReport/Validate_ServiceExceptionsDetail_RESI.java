...
public class Validate_ServiceExceptionsDetail_RESI extends BaseClass{
	...
	public void Validation_ServiceExceptionsDetailReport_RESI(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_ServiceExceptionsDetailReport_RESI") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_ServiceExceptionsDetailReport_RESI");
