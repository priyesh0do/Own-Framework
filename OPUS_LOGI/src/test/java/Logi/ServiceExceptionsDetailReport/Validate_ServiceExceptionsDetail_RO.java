...
public class Validate_ServiceExceptionsDetail_RO extends BaseClass{
	...
	public void Validation_ServiceExceptionsDetailReport_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_ServiceExceptionsDetailReport_RO") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_ServiceExceptionsDetailReport_RO");
