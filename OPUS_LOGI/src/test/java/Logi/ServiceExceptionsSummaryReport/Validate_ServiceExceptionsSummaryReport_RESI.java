...
public class Validate_ServiceExceptionsSummaryReport_RESI extends BaseClass{
	...
	public void Validation_ServiceExceptionsSummaryReport_DataValidation_RESI(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_ServiceExceptionsSummaryReport_RESI") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_ServiceExceptionsSummaryReport_RESI");
