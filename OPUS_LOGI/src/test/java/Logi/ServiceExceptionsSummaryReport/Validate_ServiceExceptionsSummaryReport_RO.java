...
public class Validate_ServiceExceptionsSummaryReport_RO extends BaseClass{
	...
	public void Validation_ServiceExceptionsSummaryReport_DataValidation_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_ServiceExceptionsSummaryReport_RO") & RunMode.equals("Yes"))
		{
		
		    test = Report.testCreate(extent, test, "Validate_ServiceExceptionsSummaryReport_RO");
