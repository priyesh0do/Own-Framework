...
public class Validate_SummaryDashboard_Report_RO extends BaseClass{
	Login login;
	HomePage sdiMegaObj;
	...
	public void Validate_SummaryDashboard_ReportValidation_RO(String Scenario,String RunMode,String ReportName, String SiteID, String LOB,
		...
		if(Scenario.equalsIgnoreCase("Validate_SummaryDashboard_Report_RO") & RunMode.equals("Yes"))
		{
			try {
		    test = Report.testCreate(extent, test, "Validate_SummaryDashboard_Report_RO");
