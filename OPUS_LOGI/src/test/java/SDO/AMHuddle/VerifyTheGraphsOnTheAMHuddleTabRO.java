...
public class VerifyTheGraphsOnTheAMHuddleTabRO extends BaseClass {
	 ...
	 * 
	 * Verify roll-off flash report DOW and Historical graph on AM Huddle
	 * 
	 */
	...
	public void VerifyTheGraphOnAMHuddleTabComm(String ReportName, String siteID, String LOB, String FromDate,
		...
		if (!Util.isTestCaseExecutable("Verify the graphs on the AM Huddle tab RO",GlobalVariables.sdoTestCase))
		{
			test = Report.testCreate(extent, test, "Verify the graphs on the AM Huddle tab RO");
		...
		else
		{
			...
			rmDashboardObj.validateRollOffDOWgraph(ToDate);
			...
			rmDashboardObj.validateRollOffHistoricalGraph();
			driver.quit();
		}	
