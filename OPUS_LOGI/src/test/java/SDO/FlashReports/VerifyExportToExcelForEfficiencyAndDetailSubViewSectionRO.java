...
public class VerifyExportToExcelForEfficiencyAndDetailSubViewSectionRO extends BaseClass {
	...
	public void OpusSDO_validateExportToExcelROFlashReport(String ReportName, String siteID, String LOB, String FromDate,
			String ToDate, String Route, String Driver, String ClockInTime,String ClockOutTime) throws Exception {
		if (!Util.isTestCaseExecutable("VerifyExportToExcelForEfficiencyAndDetailSubViewSectionRO",GlobalVariables.sdoTestCase))
		{
			test = Report.testCreate(extent, test, "Verify Export To Excel For Efficiency And Detail SubView Roll Off Flash Report");
		...
		else
		{
			...
			sdoCommObj.validateExportToExcelColumns(GlobalExpectedColumns.excelExportColumnsROFlashReport,downloadFilePath);
			driver.quit();
