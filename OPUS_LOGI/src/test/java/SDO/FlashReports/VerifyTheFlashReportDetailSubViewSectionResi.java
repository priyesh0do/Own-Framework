...
public class VerifyTheFlashReportDetailSubViewSectionResi extends BaseClass {
	 ...
	 * 
	 * Verify Residential flash report Detail SubView
	 * 
	 */

	@Test(groups = "Opus", dataProvider = "residentialFlashReport")
	public void OpusSDO_ResidentialFlashReportDetailSubView(String ReportName, String siteID, String LOB, String FromDate,
			String ToDate, String Route, String Driver, String ClockInTime,String ClockOutTime) throws Exception {
		if (!Util.isTestCaseExecutable("Verify the Flash Report  Detail sub view section Resi",GlobalVariables.sdoTestCase))
		{
			test = Report.testCreate(extent, test, "Verify the Flash Report  Detail sub view section Resi");
		...
		else
		{
			...
			sdoResiObj.validateDetailData(actualEfficiencyTable,actualDetailTable,LOB,Route,Driver,ClockInTime,ClockOutTime);
            driver.quit();
		}
