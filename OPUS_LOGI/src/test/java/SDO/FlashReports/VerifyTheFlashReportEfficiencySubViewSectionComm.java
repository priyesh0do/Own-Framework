...
public class VerifyTheFlashReportEfficiencySubViewSectionComm extends BaseClass {
	...
	public void OpusSDO_CommercialFlashReportEfficiencySubView(String ReportName, String siteID, String LOB, String FromDate,
		...
		if (!Util.isTestCaseExecutable("Verify the Flash Report  Efficiency sub view section Comm",GlobalVariables.sdoTestCase))
		{
			test = Report.testCreate(extent, test, "Verify the Flash Report  Efficiency sub view section Comm");
