...
public class Data_Validation_For_EnR_OnPropertyTime_Negative extends BaseClass {
	Login login;
	HomePage sdiMegaObj;
	...
	public void DataValidation_For_RO_TicketType_EnR_OnPropertyTime_Negative(String ReportName, String siteID, String LOB, String FromDate,
			String ToDate, String Route, String Driver,String Ticket,String TicketType) throws Exception {	
		if (!Util.isTestCaseExecutable("Data_Validation_For_EnR_OnPropertyTime_Negative",GlobalVariables.sdoTestCase))
		{
			test = Report.testCreate(extent, test, "Data_Validation_For_EnR_OnPropertyTime_Negative");
